...
void QuadEstimatorEKF::UpdateFromIMU(V3F accel, V3F gyro) {
    ...
    // make sure you comment it out when you add your own code -- otherwise e.g. you might integrate estimatedYaw twice
    ...
    ekfState(6) = quaternion.Yaw();    // estimatedYaw

    // normalize estimatedYaw to -pi .. pi
